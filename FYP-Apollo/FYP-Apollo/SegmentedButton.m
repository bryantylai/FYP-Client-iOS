...
- (void)initWithTitles:(NSArray *)buttonTitles buttonTintNormal:(UIColor *)backgroundColorNormal buttonTintPressed:(UIColor *)backgroundColorPressed actionHandler:(void (^)(int buttonIndex))actionHandler {
    ...
    for (int i = 0; i < numberOfButtons; i++) {
        ...
        newButton.layer.borderColor = [UIColor colorWithRed:0. green:0. blue:0.6 alpha:1].CGColor;
        ...
        newButton.titleLabel.font = [UIFont boldSystemFontOfSize:12];
    ...
    self.layer.borderColor = [UIColor colorWithRed:0. green:0. blue:0.6 alpha:1].CGColor;
